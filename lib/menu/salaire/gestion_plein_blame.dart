...
gravité de la faute. */
  final List<String> _options = ['Cliquez ici pour choisir','Avertissement Verbal', 'Blâme', 'La mise à pied de 1 à 8 jours avec privation de salaire', 'licenciement avec préavis','licenciement sans préavis'];
  ...
  BoxUser(String nomprenom, double nbrSanction, String typeSanction,dateSanction,motifSanction, GlobalKey key) {
    return Container(
      height: 50,
      width: MediaQuery.of(context).size.width,
